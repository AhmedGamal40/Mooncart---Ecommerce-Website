...
import { herolist } from "../../assets/data/data.js";
            ...
            <div>
              ...
              <div className="flex items-center justify-center gap-3 mt-5">
                {colors.map((color, i) => (
                  <div
                    key={i}
                    onClick={() => handelColorClick(color.value)}
...
const Banner = () => {
  return (
    <>
      <div className="py-20 container flex flex-col lg:flex-row item-center gap-5">
        <div>
          <BannerCard
      ...
      <div className="w-full h-full relative">
        ...
        >
          <div>
            ...
            <p className="text-lg font-normal leading-non">{desc}</p>
          </div>
